...
class TransportationController extends Controller
{
    ...
    {
        return view('pages.backend.pages.tour.pages.transportation.partials.create', compact('tour'));
    }
    ...
    {
        return view('pages.backend.pages.tour.pages.transportation.partials.edit', compact('transportation', 'tour'));
    }
