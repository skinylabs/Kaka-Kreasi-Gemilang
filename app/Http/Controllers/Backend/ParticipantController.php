...
class ParticipantController extends Controller
{
    ...
    public function index(Tour $tour)
    {
        ...
        return view('pages.backend.pages.tour.pages.participant.index', compact('participant', 'tour'));
    }
    ...
    public function create(Tour $tour)
    {
        ...
        return view('pages.backend.pages.tour.pages.participant.partials.create', compact('tour', 'participant', 'transportation'));
    }
    ...
    public function store(Request $request, Tour $tour)
    {
        ...
        $request->validate([
            ...
            'transportation_slug' => 'nullable|string|max:50',
        ]);
     ...
     */
    public function edit(Participant $participant, Tour $tour)
    {
        $participant = Participant::where('tour_id', $tour->id)->get();
        return view('pages.backend.pages.tour.pages.participant.partials.edit', compact('participant', 'tour', 'parti$participant'));
    }
    ...
    public function update(Request $request, Tour $tour, Participant $participant)
    {
        ...
        $request->validate([
            ...
            'transportation_id' => 'required|exists:transportations,id', // Ensure the transportation exists
        ]);
