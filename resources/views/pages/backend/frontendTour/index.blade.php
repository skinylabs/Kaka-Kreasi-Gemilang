            ...
            <table
                ...
                <thead>
                    <tr class="bg-slate-200 sticky top-0 text-gray-600 font-bold text-sm uppercase">
                        ...
                        <th class="px-6 py-3"><span>Nama Tempat</span></th>
                        <th class="px-6 py-3"><span>Gambar</span></th>
                        <th class="px-6 py-3"><span>Deskripsi</span></th>
                        <th class="px-6 py-3"><span>Harga</span></th>
                        <th class="px-6 py-3"><span>Rating</span></th>
